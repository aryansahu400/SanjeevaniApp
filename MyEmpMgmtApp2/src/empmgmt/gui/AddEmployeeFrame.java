...
public class AddEmployeeFrame extends javax.swing.JFrame {
    ...
    private void btnAddEmpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmpActionPerformed
        if(!validateInputs()){
            JOptionPane.showMessageDialog(null,"No data entered, please enter data");
            return;
        }
        try{
            int empNo=Integer.parseInt(txtEmpNo.getText().trim());
            String empName=txtEname.getText();
            double empSal=Double.parseDouble(txtSal.getText().trim());
        
            EmpPojo emp=new EmpPojo(empNo,empName,empSal);
            boolean result=EmpDao.addEmp(emp);
            clearAll();
            if(result){
                JOptionPane.showMessageDialog(null,"Record insereted Succesfully");
                return;
            }else{
                JOptionPane.showMessageDialog(null,"Record not insereted Succesfully");
                return;
            }
            ...
            JOptionPane.showMessageDialog(null,"Please insert numbers in Employee id and in Employee Salary");
            e.printStackTrace();
    ...
    private boolean validateInputs() {
        if((txtEmpNo.getText().trim()).isEmpty()||(txtEname.getText()).isEmpty()||txtSal.getText().trim().isEmpty())return false;
        else return true;
    }
