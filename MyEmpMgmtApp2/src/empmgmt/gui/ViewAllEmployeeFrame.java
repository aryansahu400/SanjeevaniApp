...
public class ViewAllEmployeeFrame extends javax.swing.JFrame {
    ...
    try{
        List<EmpPojo> listOfEmp=EmpDao.getAllEmployees();
        StringBuilder str=new StringBuilder("EmpId\t\tName\t\tSalary \n");
        
        if(listOfEmp.isEmpty()){
            JOptionPane.showMessageDialog(null,"No records found!","NO RECORDS",JOptionPane.PLAIN_MESSAGE);
        }
        for(EmpPojo emp:listOfEmp){
            str.append(emp);
        }
        JOptionPane.showMessageDialog(null,"Success");
        txtAllEmp.setText(str.toString());
    }
