...
public class ViewConfirmedAppointmentsRequestFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient ID", "Patient Name", "OPD", "Scheduled date"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewConfirmedAppointmentsRequestFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
