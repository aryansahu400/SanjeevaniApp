...
public class ViewReceptionistFrame extends javax.swing.JFrame {
    ...
    private void loadDetails() {
        ...
        List<ReceptionistPojo> list=null;
        try {
            list=ReceptionistDao.getAllreceptonistDetails();
            
        } catch (SQLException ex) {
            JOptionPane.showMessageDialog(null,"Error in database in viewReceptionistFrame");
            ex.printStackTrace();
        }
        for(ReceptionistPojo receptionist: list){
            Object[] arr=new Object[3];
            arr[0]=receptionist.getReceptionistName();
            arr[1]=receptionist.getReceptionistName();
            arr[2]=receptionist.getGender();
            model.addRow(arr);
        }
